...
export const parsePermissionBitfield = (permBitfield: string) => {
	let currentPermissions = [];
	const permissionUpper = Math.floor(Number(permBitfield) / 0x100000000);
	const permissionLower = Math.floor(Number(permBitfield) % 0x100000000);
	for (let key in permissions) {
		if (
			(permissions[key] >= 0x100000000 &&
				permissionUpper & Math.floor(permissions[key] / 0x100000000)) ||
			(permissions[key] < 0x100000000 &&
				permissionLower & permissions[key])
		) {
